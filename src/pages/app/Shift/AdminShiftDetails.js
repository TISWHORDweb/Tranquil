                    ...
                    <div className="container">
                        <div className="mt-5">
                            <div className="justify-content-space">
                                ...
                                <div className="">
                                    <button className='btnDark'> <i class='bx bx-edit-alt'></i> Edit Shift</button>
                                </div>
                            </div>
                            ...
                            <div className="justify-content-space">
                                ...
                                <p><span className='third'>Created at :</span> <br /> <span className='fw6 '>{DateConverter(shift.creationDateTime)}</span></p>
                            </div>
                        </div>
