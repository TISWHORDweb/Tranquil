...
function Table({ employees }) {
    ...
    const HandleDisable = (e) => {
        ...
        if (!id) {
            ...
            console.log(body);
            axios.put(`${USER_BASE_URL}/admin/employee/disable`, body, axiosConfig)
                .then(response => {
    ...
    const HandleEnable = (e) => {
        ...
        if (!id) {
            ...
            axios.put(`${USER_BASE_URL}/admin/employee/enable`, body, axiosConfig)
                .then(response => {
                    const data = response.data
                    ...
                    <div class="modal-content">
                        <div class="modal-body AlertModal p-5">
                            <center>
                                ...
                                {disable ?
                                    <p>Are you sure you want to Disable this employee ?</p>
                                    : <p>Are you sure you want to Enable this employee ?</p>
                                }
